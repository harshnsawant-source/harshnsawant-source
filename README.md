### Hi, I'm Harsh 👋 — AI Engineer

I build AI systems that ship: LLM agents, RAG, and local-first AI products.

🔹 **[Obsidian Intelligence Layer](https://github.com/harshnsawant-source/Obsidian-intelligence-layer)** — a local-first **multi-agent system**: hybrid local + free-cloud LLM routing, semantic memory/RAG, agent-to-agent delegation, a planner, and circuit-breaker failover. *(Python, no paid APIs)*
...
📫 harshnsawant@gmail.com · 📍 Pune, India
